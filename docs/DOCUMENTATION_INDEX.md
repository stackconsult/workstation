# Workstation Documentation Index

Welcome to the Workstation documentation! This index helps you find exactly what you need.

## 🚀 Getting Started

**New to Workstation?** Start here:
- [README](../README.md) - Project overview and quick start
- [START_HERE](../START_HERE.md) - 30-second quick start guide
- [**Quick Start Guide**](guides/QUICK_START.md) - **5-minute setup guide** ⭐
- [Enterprise Automation Guide](guides/ENTERPRISE_AUTOMATION.md) - Advanced features and CI/CD
- [How to Use the Browser Agent](guides/HOW_TO_USE_BROWSER_AGENT.md) - Complete user guide
- [Detailed Quick Start](guides/QUICKSTART.md) - Legacy detailed guide

## 📚 User Guides

Essential guides for using Workstation:

### Core Functionality
- [Quick Start](guides/QUICK_START.md) - 5-minute setup ⭐ **Recommended**
- [Enterprise Automation](guides/ENTERPRISE_AUTOMATION.md) - CI/CD, security, error handling
- [Browser Agent Demo Guide](guides/BROWSER_AGENT_UI_DEMO_GUIDE.md) - Visual walkthrough
- [Standard Quick Start](guides/QUICKSTART.md) - Legacy standard setup
- [Quick Start (Integrated)](guides/QUICKSTART_INTEGRATED.md) - Integrated deployment
- [Quick Start (Production)](guides/QUICKSTART_PRODUCTION.md) - Production deployment

### Development & Deployment
- [Build Guide](guides/BUILD.md) - Building from source
- [Deployment Guide](guides/DEPLOYMENT.md) - Deployment options (Docker recommended)
- [Deployment Checklist](guides/DEPLOYMENT_CHECKLIST.md) - Pre-deployment verification
- [Deployment (Integrated)](guides/DEPLOYMENT_INTEGRATED.md) - Integrated deployment
- ~~[Railway Template](guides/railway-template.md)~~ - **Deprecated: Use Docker instead**
- [Contributing Guidelines](guides/CONTRIBUTING.md) - How to contribute

### Security & Operations
- [**Enterprise Automation Guide**](guides/ENTERPRISE_AUTOMATION.md) - CI/CD, error handling, security ⭐
...
Deep dive into how Workstation works:

- [Architecture Overview](architecture/ARCHITECTURE.md) - System architecture
- [MCP Architecture](architecture/MCP_ARCHITECTURE.md) - Model Context Protocol integration
- [Project Identity](architecture/PROJECT_IDENTITY.md) - Project evolution and vision
- [Roadmap](architecture/ROADMAP.md) - Future plans and phases
...
**Get started quickly**
→ [QUICK_START.md](guides/QUICK_START.md) ⭐ (5 minutes)

**Set up enterprise CI/CD and security**
→ [ENTERPRISE_AUTOMATION.md](guides/ENTERPRISE_AUTOMATION.md)

**Use the browser automation**
→ [HOW_TO_USE_BROWSER_AGENT.md](guides/HOW_TO_USE_BROWSER_AGENT.md)

**Deploy to production with Docker**
→ [ENTERPRISE_AUTOMATION.md](guides/ENTERPRISE_AUTOMATION.md#docker-deployment) → [DEPLOYMENT_CHECKLIST.md](guides/DEPLOYMENT_CHECKLIST.md)
...
**Set up the web UI**
→ [INTERFACE_QUICKSTART.md](guides/INTERFACE_QUICKSTART.md)

**Secure my deployment**
→ [ENTERPRISE_AUTOMATION.md](guides/ENTERPRISE_AUTOMATION.md#security-guards) → [SECURITY.md](guides/SECURITY.md)

**Monitor my system**
→ [MONITORING.md](guides/MONITORING.md) → [ENTERPRISE_AUTOMATION.md](guides/ENTERPRISE_AUTOMATION.md#cicd-pipeline-features)
