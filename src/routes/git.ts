 ...
 */
router.get('/git/status', authenticateToken, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/git/branches', authenticateToken, async (req: Request, res: Response) => {
  try {
    const githubToken = process.env.GITHUB_TOKEN;
    const gitService = getGitService(process.cwd(), githubToken);
 ...
 */
router.post('/git/push', authenticateToken, validateBody(pushSchema), async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/git/prs', authenticateToken, validateQuery(listPRsSchema), async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/git/pr', authenticateToken, validateBody(createPRSchema), async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/git/sync', authenticateToken, async (req: Request, res: Response) => {
  try {
    const githubToken = process.env.GITHUB_TOKEN;
    const gitService = getGitService(process.cwd(), githubToken);
 ...
 */
router.post('/git/commit', authenticateToken, validateBody(commitSchema), async (req: Request, res: Response) => {
  try {
