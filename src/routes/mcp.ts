      ...
      switch (toolName) {
        case "workflow_create":
          ...
          result = {
            success: true,
            message:
              "Use POST /api/v2/workflows endpoint for workflow creation",
        ...
        case "scrape_website":
          ...
          workflowDefinition = {
            ...
            tasks: [
              ...
              ...(arguments_.selectors &&
              typeof arguments_.selectors === "object"
                ? Object.entries(arguments_.selectors).map(
                    ([key, selector]) => ({
                      name: `extract_${key}`,
                      agent_type: "browser",
                      action: "getText",
          ...
          workflowDefinition = {
            ...
            tasks: [
              ...
              ...(arguments_.fields && typeof arguments_.fields === "object"
                ? Object.entries(arguments_.fields).map(
                    ([selector, value]) => ({
...
router.get("/mcp/server-info", (req: Request, res: Response) => {
  ...
  res.json({
    ...
    version: "1.0.0",
    description:
      "Model Context Protocol server for Workstation browser automation",
    capabilities: {
