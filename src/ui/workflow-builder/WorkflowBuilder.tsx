...
export const WorkflowBuilder: React.FC<WorkflowBuilderProps> = ({
  ...
  const handleSave = useCallback(() => {
    ...
    onSave?.(template);
  }, [nodes, edges, workflowName, workflowDescription, initialWorkflow, validateWorkflow, onSave]);
  ...
  const handleExecute = useCallback(() => {
    ...
    onExecute?.(template);
    setShowPreview(true);
  }, [nodes, edges, workflowName, workflowDescription, initialWorkflow, validateWorkflow, onExecute]);

  return (
    <div className="workflow-builder" style={{ width: '100%', height: '100vh' }}>
      {/* Toolbar */}
