...
check "Simple ZIP size > 100KB" "test $(stat -c%s dist/workstation-ai-agent-v2.1.0.zip) -gt 100000"
check "Enterprise ZIP size > 140KB" "test $(stat -c%s dist/workstation-ai-agent-enterprise-v2.1.0.zip) -gt 140000"
