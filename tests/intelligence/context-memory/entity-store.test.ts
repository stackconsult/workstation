...
import { EntityStore, getEntityStore } from '../../../src/intelligence/context-memory/entity-store';
...
describe('EntityStore', () => {
  ...
  it('should create relationships', async () => {
    ...
    await entityStore.createRelationship(entity1.id, entity2.id, 'depends_on', 0.8);
