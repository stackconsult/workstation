...
describe("MCP Routes", () => {
  ...
  describe("GET /api/v2/mcp/tools", () => {
    ...
    it("should reject requests without authentication", async () => {
      await request(app).get("/api/v2/mcp/tools").expect(401);
    });
    ...
    it("should include browser automation tools", async () => {
      ...
      const toolNames = (response.body.tools as Tool[]).map(
        (t: Tool) => t.name,
      );
  ...
  describe("GET /api/v2/mcp/resources", () => {
    it("should return list of resources", async () => {
      ...
      const resourceNames = typedResponse.resources.map(
        (r: Resource) => r.name,
      );
    ...
    it("should require authentication", async () => {
      await request(app).get("/api/v2/mcp/resources").expect(401);
    });
  });
  ...
  describe("GET /api/v2/mcp/prompts", () => {
    ...
    it("should require authentication", async () => {
      await request(app).get("/api/v2/mcp/prompts").expect(401);
    });
  });
  ...
  describe("GET /api/v2/mcp/server-info", () => {
    ...
    it("should not require authentication", async () => {
      ...
      await request(app).get("/api/v2/mcp/server-info").expect(200);
    });
