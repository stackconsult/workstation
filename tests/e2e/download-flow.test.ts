...
describe('E2E: Download Flow Tests', () => {
  ...
  describe('Error Handling Tests', () => {
    ...
    test('TC-015: Should return 404 for non-whitelisted file', async () => {
      const response = await request(API_URL)
    ...
    test('TC-015: Should handle missing download files gracefully', async () => {
  ...
  describe('Performance Tests', () => {
    ...
    test('TC-018: Workflow builder download should complete quickly', async () => {
      const startTime = Date.now();
    ...
    test('TC-019: Should handle concurrent downloads', async () => {
...
describe('E2E: Auto-Updater Tests', () => {
  ...
  describe('Agent Status Updater', () => {
    ...
    test('Should fetch agent status from API', async () => {
      const response = await request(API_URL)
